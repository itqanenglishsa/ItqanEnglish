...
(function () {
  ...
  // [الحماية 1]: طرد غير المشتركين (الروابط المنسوخة)
if (!session || error) {
    // 🧹 تنظيف الصفحة الأصلية قبل عرض صفحة الحماية
    ...
    document.documentElement.innerHTML = `
        ...
        <body style="display:flex; flex-direction:column; align-items:center; justify-content:center; height:100vh; text-align:center; font-family:sans-serif; background:#f8fafc; margin:0; padding:20px;">
            ...
            <img src="forfun.PNG" alt="Access Denied" style="width:180px; margin-bottom:20px; border-radius:12px;">
    ...
    // ❌ إزالة إعادة التوجيه التلقائية التي كانت تسبب صفحة 404
    // setTimeout(() => { window.location.href = "../login.html"; }, 3000);

    // ✔ تم الإبقاء على صفحة الحماية فقط دون أي انتقال أو تمرير
    return;
}
